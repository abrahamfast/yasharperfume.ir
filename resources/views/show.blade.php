    ...
    <x-navbar/>
        ...
        <div class="product-image-slider-wrapper space-pb--30 space-mb--30">
            <div class="product-image-single">
                <img src="assets/img/product-slider/product1.png" class="img-fluid" alt="">
            </div>
            <div class="product-image-single">
        ...
        <div class="product-content-header-area border-bottom--thick space-pb--30">
                    ...
                    <div class="col-12">
                        <div class="product-content-header">
                            <div class="product-content-header__main-info">
                                <h3 class="title">Lather Demo Bag Name</h3>
                                <div class="price">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <p class="space-mb--25">There are many variations of passages of Lorem <br> Ipsum available, but
        ...
        <div class="product-content-safety border-bottom--thick space-pt--15 space-pb--15">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h4><img src="assets/img/icons/security.svg" class="injectable" alt=""> Secure Payment Method.
                        </h4>
                    </div>
                </div>
            </div>
        ...
        <div class="product-content-description space-pt--25 space-pb--25">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h4 class="space-mb--5">Specification</h4>
